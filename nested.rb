...
def dennis_ritchies_language
	programmer_hash = 
     ...
     dennis_ritchies_language = programmer_hash[:dennis_ritchie][:languages][0]
...
# }
    ...
    programmer_hash[:yukihiro_matsumoto] = {:yukihiro_matsumoto =>  {:known_for => "Ruby", :languages => ["LISP", "C"]}}
